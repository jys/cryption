...
# <donnejesForme>         ::= { <numejroLemmeCat> <genre> <nombre> <personne> <temps> }
# <identifiantLemme>      ::= <Entier3>
# <macro>                 ::= <Entier1>
# <numejroLemmeCat>       ::= <Entier3>
# <genre>                 ::= <Entier1>
# <nombre>                ::= <Entier1>
# <personne>              ::= <Entier1>
# <temps>                 ::= <Entier1>
...
class QcFormes(QcIndex):
    ...
    def ajouteForme(self, identifiantForme, description):
        ...
        for (numejroLemmeCat, genre, nombre, personne, temps) in description:
            # { <numejroLemmeCat> <genre> <nombre> <personne> <temps> }
            self.ejcritNombre3(numejroLemmeCat)
    ...
    def trouveDonnejes(self, identifiantForme):
        ...
        for ii in range(nombreDejfinitions):
            # <numejroLemmeCat> <genre> <nombre> <personne> <temps>
            numejroLemmeCat = self.litNombre3()
