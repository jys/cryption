...
sp7Modehles = (
    ...
    'DETms ADJms NCms ADJms', 'DETfs ADJfs NCfs ADJfs', 'DETfp ADJfp NCfp ADJfp', 'DETmp ADJmp NCmp ADJmp',
...
sp7NcInterdits = (
    'abord', 'ailleurs', 'aller', 'an', 'après', 'attendant', 'attendu', 'autre', 'avance', 'avant', 'avoir', 'bas', 'bien', 'blanc', 'bleu', 'bref', 'car', 'cas', 'côté', 'coup', 'dans', 'début', 'dernier', 'dessus', 'douce', 'droit', 'détail', 'effet', 'encore', 'entrant', 'est', 'étant', 'être', 'face', 'façon', 'fait', 'fin', 'fois', 'forme', 'grand', 'grande', 'gros', 'haut', 'hâte', 'jaune', 'jeter', 'juste', 'large', 'lieu', 'loin', 'long', 'lors', 'malgré', 'mieux', 'milieu', 'moins', 'même', 'net', 'noir', 'outre', 'pari', 'paris', 'part', 'partie', 'pas', 'passant', 'peine', 'pendant', 'petit', 'petite', 'peu', 'plus', 'plutôt', 'point', 'pour', 'privé', 'près', 'quantité', 'reste', 'rien', 'rire', 'rouge', 'somme', 'sorte', 'suite', 'suivant', 'tard', 'temps', 'travers', 'tôt', 'tout', 'vers', 'vert'
    )
