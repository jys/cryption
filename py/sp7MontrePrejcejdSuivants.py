...
def usage():
    ...
    print (f"""© l'ATEJCON.
En partant d'une graphie de lemme, liste les précédents et les suivants
dans le fichier .sp7lemmes avec les formes associées.
...
def montrePrejSuiv(racine, graphie):
